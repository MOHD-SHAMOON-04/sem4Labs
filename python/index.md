...
# LAB_5
## 20-02
**Ques1:** Write a Python program to delete all duplicate elements in a list

---
**Ques2:** Write a Python program to print elements with frequency greater than a threshold frequency say it be 'k'

---
**Ques3:** Write a Python program to right rotate elements in a list

---
**Ques4:** Write a Python program to find frequency of all elements in a list, and seperate them into two differnt lists named uniques and duplicates

---
**Ques5:** Write a Python program to seperate prime and non-prime numbers into two different lists

---
**Ques6:** Write a Python program to shift all the zeroes to the right and all the non-zeroes to the left in a list

---
**Ques7:** Write a Python program to find the differnece between two consecutive elements in a list and put it into a seperate lists
